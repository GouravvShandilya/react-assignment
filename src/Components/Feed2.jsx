...
import postPic2 from "../utils/postPic2.png"
    ...
    return (
        <div className='w-[100%] h-[90%] bg-[#FFFFFF] flex  flex-col items-center  justify-center rounded-b-xl '>
            ...
            <div className='w-[85%] h-[55%] flex items-center justify-center '>
                <img className='w-[100%] h-[100%] bg-cover' src={postPic2} alt="" />
            </div>
            <div className='w-[85%] h-[15%]  flex gap-1'>
                <div className='  flex items-center justify-center gap-[0.5vw]  w-[10%] h-[100%]'>
                    <AiOutlineHeart className='text-[1.5vw]' />
                    <h1 className='text-[1.3vw] font-[Gilroy] '>
                        9.8k
                    </h1></div>
                <div className=' flex items-center justify-center gap-[0.5vw]  w-[10%] h-[100%]'>
                    <FaRegComment className='text-[1.5vw]' />
                    <h1 className='text-[1.3vw] font-[Gilroy] '>
                        8.6k
                    </h1>
                </div>
                <div className=' flex items-center justify-center gap-[0.5vw]  w-[10%] h-[100%]'>
                    <PiShareFatBold className='text-[1.5vw]' />
                    <h1 className='text-[1.3vw] font-[Gilroy] '>
                        7.2k
                    </h1>
                </div>
